...
WebUI.callTestCase(findTestCase('Reused TC/4. Hybrid Registration/1. Contact Customer Page'), [('title') : title, ('givenName') : givenName
        , ('familyName') : familyName, ('email') : email, ('dateOfBirth') : dateOfBirth, ('KK') : KK, ('buildingName') : buildingName
        ...
        , ('validTill') : validTill, ('isWNA') : isWNA, ('issuingType') : issuingType, ('isResidentialRegistration') : false], 
