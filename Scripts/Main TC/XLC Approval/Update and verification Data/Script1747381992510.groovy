...
WebUI.callTestCase(findTestCase('Main TC/XLC Approval/Filter based on TicketID'), [('user') : findTestData('Internal Data/User Login').getValue(
            1, 2), ('pass') : findTestData('Internal Data/User Login').getValue(2, 2), ('ApplicationID') : applicationID
        , ('serviceType') : 'Reactivation'], FailureHandling.STOP_ON_FAILURE)
