...
WebUI.callTestCase(findTestCase('Main TC/XLC Approval/Filter based on TicketID'), [('user') : findTestData('Internal Data/User Login').getValue(1, 1)
        , ('pass') : findTestData('Internal Data/User Login').getValue(2, 1), ('ApplicationID') : ApplicationID, ('serviceType') : 'Reactivation'
        , ('channel') : 'XL CENTER'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('General/obj contains', [('obj') : 'button', ('attr') : 'text()', ('val') : 'Approve']))
