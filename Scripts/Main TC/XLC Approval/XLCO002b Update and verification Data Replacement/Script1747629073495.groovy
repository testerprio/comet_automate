...
WebUI.setText(findTestObject('General/obj', [('obj') : 'input', ('attr') : '@formcontrolname', ('val') : 'newICCID']), newICCID)

tipeLayanan = WebUI.getText(findTestObject('Spesific/3. XLC Approval/textfield tipeLayanan'))

String reasonReplace

if (tipeLayanan == 'Replacement') {
	reasonReplace = WebUI.getText(findTestObject('Spesific/3. XLC Approval/textfield reasonReplace'))
}

if ((tipeLayanan == 'Replacement' && reasonReplace != 'Hilang') || tipeLayanan == 'Upgrade Sim Card') {
