...
WebUI.click(findTestObject('General/obj contains', [('obj') : 'button', ('attr') : 'text()', ('val') : 'Post to Pre']))

WebUI.takeScreenshot()

WebUI.click(findTestObject('General/obj contains', [('obj') : 'button', ('attr') : 'text()', ('val') : 'Next']))

WebUI.callTestCase(findTestCase('Reused TC/1. General/Select dropdown by Value'), [('selectName') : 'pricePlan', ('valueofOption') : changetoPricePlan], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('General/obj', [('obj') : 'textarea', ('attr') : '@formcontrolname', ('val') : 'memo']), memo)
