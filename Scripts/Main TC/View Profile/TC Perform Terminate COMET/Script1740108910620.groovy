...
WebUI.click(findTestObject('General/obj contains', [('obj') : 'button', ('attr') : 'text()', ('val') : 'Terminate']))

WebUI.check(findTestObject('General/obj', [('obj') : 'p-checkbox', ('attr') : '@formcontrolname', ('val') : 'billPaid']))

WebUI.setText(findTestObject('General/obj', [('obj') : 'textarea', ('attr') : '@formcontrolname', ('val') : 'additionalInfo']), 
    'Testing terminate')

WebUI.takeScreenshot()

WebUI.click(findTestObject('General/obj contains', [('obj') : 'button', ('attr') : '@class', ('val') : 'orange-btn ml-2']))
