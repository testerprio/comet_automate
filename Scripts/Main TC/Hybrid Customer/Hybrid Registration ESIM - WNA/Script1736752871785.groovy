...
WebUI.callTestCase(findTestCase('Reused TC/4. Hybrid Registration/1. Contact Customer Page'), [('title') : title, ('givenName') : givenName
        , ('familyName') : familyName, ('email') : email, ('dateOfBirth') : dateOfBirth, ('dobSplit') : dobSplit, ('KK') : KK
        , ('buildingName') : buildingName, ('streetName') : streetName, ('province') : province, ('city') : city, ('postCode') : postCode
        , ('companyName') : companyName, ('streetNumber') : streetNumber, ('homePhone') : homePhone, ('identificationID') : identificationID
        , ('issuingAuthority') : issuingAuthority, ('validTill') : validTill, ('splitValidCardIDDate') : splitValidCardIDDate
        , ('isWNA') : isWNA, ('issuingType') : issuingType], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Reused TC/4. Hybrid Registration/3.b Select Resource page - ESIM'), [('msisdn') : msisdn
        , ('iccid') : iccid, ('eid') : eid, ('deviceType') : deviceType], FailureHandling.STOP_ON_FAILURE)
