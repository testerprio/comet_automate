...
WebUI.click(findTestObject('Spesific/MenuSub', [('subMenu') : 'Verification Mobile']))
...
if (isApprove == true) {
    WebUI.callTestCase(findTestCase('Reused TC/5. Case Registration/a. Approve case registration'), [:], FailureHandling.STOP_ON_FAILURE)
} else {
    WebUI.callTestCase(findTestCase('Reused TC/5. Case Registration/b. Reject case registration'), [:], FailureHandling.STOP_ON_FAILURE)
}
