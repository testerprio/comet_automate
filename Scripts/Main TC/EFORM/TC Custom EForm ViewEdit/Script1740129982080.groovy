...
WebUI.click(findTestObject('Spesific/MenuSub', [('subMenu') : 'Form']))

WebUI.click(findTestObject('Spesific/MenuSub', [('subMenu') : 'Custom E-Form']))

WebUI.setText(findTestObject('General/obj', [('obj') : 'input', ('attr') : '@formcontrolname', ('val') : 'searchName']), 
    formName)
