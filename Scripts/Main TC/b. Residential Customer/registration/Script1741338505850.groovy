...
WebUI.click(findTestObject('Spesific/MenuSub', [('subMenu') : 'Residential Customer']))
...
WebUI.callTestCase(findTestCase('Reused TC/4. Hybrid Registration/1. Contact Customer Page'), [('title') : title, ('givenName') : givenName
        ...
        , ('validTill') : validTill, ('isWNA') : isWNA, ('issuingType') : issuingType, ('customerType') : 'Personal Regular'
        , ('customerSubType') : 'Consumer - Reg', ('isResidentialRegistration') : true], FailureHandling.STOP_ON_FAILURE)
