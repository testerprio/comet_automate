...
WebUI.callTestCase(findTestCase('Reused TC/3. User Management - Roles/1. Search Role User Access'), [('appType') : 'Sales Agent'
        , ('agentCategory') : 'XL Center', ('roleId') : 'XLC Sanity'], FailureHandling.STOP_ON_FAILURE)
